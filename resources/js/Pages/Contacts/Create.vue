  ...
  <app-layout title="Contacts">
    ...
    <div class="container py-8">
      <h1 class="text-3xl font-semibold text-gray-700 mb-3">
        <span class="text-indigo-500">Contacto /</span> Create
      </h1>
      ...
      <div class="bg-white px-6 py-8 rounded-lg shadow">
        ...
        <div class="grid grid-cols-2 gap-6">
          ...
          <div>
            <label>
              First Name
              <Input v-model="contact.first_name" type="text" class="w-full"></Input>
            </label>
          </div>
          ...
          <div>
            <label>
              Postal Code
              <Input v-model="contact.postal_code" type="text" class="w-full"></Input>
            </label>
          </div>
